...
from .views import RegisterView, CustomTokenObtainPairView, ProfileAPIView, AdminUserListView, SavedPaymentMethodListCreateView, SavedPaymentMethodDetailView, SetDefaultPaymentMethodView, ChangePasswordView, UserDashboardSearchView
...
urlpatterns = [
    ...
    path('search/', UserDashboardSearchView.as_view(), name='user-dashboard-search'),
